...
class _ClothesState extends State<Clothes> {
  ...
  void _addList(Money mon) {
    if (mon.inorout == true) {
      FirebaseFirestore.instance.collection('clothes_money_in').add({
        'date': mon.date,
        'inorout': mon.inorout,
        'cost': mon.cost,
        'memo': mon.memo
      ...
      FirebaseFirestore.instance.collection('clothes_money_out').add({
        'date': mon.date,
        'inorout': mon.inorout,
        'cost': mon.cost,
        'memo': mon.memo
