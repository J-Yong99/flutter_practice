...
class _FoodState extends State<Food> {
  ...
  void _addList(Money mon) {
    if (mon.inorout == true) {
      FirebaseFirestore.instance.collection('food_money_in').add({
        'date': mon.date,
        'inorout': mon.inorout,
        'cost': mon.cost,
        'memo': mon.memo
      ...
      FirebaseFirestore.instance.collection('food_money_out').add({
        'date': mon.date,
        'inorout': mon.inorout,
        'cost': mon.cost,
        'memo': mon.memo
